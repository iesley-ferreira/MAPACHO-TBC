...
const OrdersTable: React.FC<OrdersTableProps> = ({
  ...
  return (
    <section className="flex items-center w-full py-8">
      <div className="container md:max-w-4xl mx-auto overflow-hidden">
        <div className="mb-16 overflow-hidden">
          <div className="overflow-x-auto">
            <div className="flex items-center justify-between rounded-lg py-3 md:py-5 px-4 md:px-8">
              <div className="flex items-center w-full justify-between">
                <div className="w-4/12 md:w-2/12 font-heading text-center font-semibold md:hidden">
                  <p>ID</p>
                </div>
                <div className="md:w-2/12 font-heading text-center font-semibold hidden md:block">
                  <p>ID Pedido</p>
                </div>
                <div className="w-4/12 md:w-2/12  md:pr-0 font-heading text-center font-semibold">
                  <p>Data</p>
                </div>
                <div className="w-4/12 md:w-2/12 md:pr-0 font-heading text-center font-semibold">
                  <p>Status</p>
                ...
                <div className="font-heading md:w-2/12 text-center font-semibold hidden md:block">
                  <p>Detalhes</p>
                </div>
                        ...
                        order.products.map((product) => (
                          ...
                          >
                            <div className="flex items-center gap-4 w-full ">
                              ...
                              <div className="rounded-lg w-36 lg:w-24 h-24 sm:w-24 flex items-center justify-center">
                                <img
                                  src={
                                    product.imagemURL ||
